...
class ReservaController extends Controller
{
    ...
    /**
     * Devuelve el listado de reservas en formato JSON para la API (Paso 9).
     */
    public function apiIndex()
    {
        // Traemos las reservas con sus relaciones
        $reservas = Reserva::with(['cancha', 'user'])->get();

        // Respondemos con un estado 200 (OK) y los datos en formato JSON
